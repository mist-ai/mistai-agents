...
def get_company_overview_metricss(ticker):
    """Fetch financial overview data from TradingView for a given ticker."""
    ...
    try:
        ...
        for div in div_elements:
            try:
                ...
                financial_data.append({'title': title_text, 'data': data_text})
